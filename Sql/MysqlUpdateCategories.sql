...
update cashflows set Category = 'Bank' where GroupLib like '%COTISATION%';
update cashflows set Category = 'Bank' where GroupLib like '%FRAIS%';
update cashflows set Category = 'Bank' where Libelle like '%CAFINISTERE%';
update cashflows set Category = 'Bank' where Libelle like '%PREDICA%';
update cashflows set Category = 'Bank' where Libelle like '%SUPPLETIS%';
update cashflows set Category = 'Bank' where Libelle like '%GARANTIE%';
update cashflows set Category = 'Bank' where Libelle like '%CARTEGOLD%';
update cashflows set Category = 'Bank' where Libelle like '%COMMISSION%';
update cashflows set Category = 'Bank' where GroupLib like '%CRCAM%';
update cashflows set Category = 'Bank' where GroupLib like '%B-PREDICA%';
...
update cashflows set Category = 'Rent' where GroupLib like '%WEBCOMPTEJOINTCMB%';
update cashflows set Category = 'Rent' where Libelle like '%HERROU%';
update cashflows set Category = 'Rent' where GroupLib like '%WEBMONFORTNICOLE%';
...
update cashflows set Category = 'Toxics' where Libelle like '%BODRUM%';
update cashflows set Category = 'Toxics' where Libelle like '%ATMOSPHERE%';
update cashflows set Category = 'Toxics' where Libelle like '%LE%/%';
update cashflows set Category = 'Toxics' where Libelle like '%cupid%';
update cashflows set Category = 'Toxics' where Libelle like '%CAFFE%';
update cashflows set Category = 'Toxics' where Libelle like '%BLIND P%';
update cashflows set Category = 'Toxics' where Libelle like '%TABAC%';
update cashflows set Category = 'Toxics' where Libelle like '%ARENA%';
update cashflows set Category = 'Toxics' where Libelle like '%LA BASE%';
update cashflows set Category = 'Toxics' where Libelle like '%PETITE CONC%';
update cashflows set Category = 'Toxics' where Libelle like '%LESVOUTES%';
update cashflows set Category = 'Toxics' where Libelle like '%LAPETITECONCUR%';
...
update cashflows set Category = 'Food' where Libelle like '%CARREFOUR%';
update cashflows set Category = 'Food' where Libelle like '%AUCHAN%';
update cashflows set Category = 'Food' where Libelle like '%CASINO%';
update cashflows set Category = 'Food' where Libelle like '%SALVATORE%';
update cashflows set Category = 'Food' where Libelle like '%ELIOR07071%';
update cashflows set Category = 'Food' where Libelle like '%BUFFALO%';
update cashflows set Category = 'Food' where Libelle like '%SUPERU%';
update cashflows set Category = 'Food' where Libelle like '%LECLERC%';
update cashflows set Category = 'Food' where Libelle like '%PIZZA%';
update cashflows set Category = 'Food' where Libelle like '%CHEZCHARLOT%';
update cashflows set Category = 'Food' where Libelle like '%INSTANTGOUR%';
update cashflows set Category = 'Food' where Libelle like '%AISEBREIZH%';
update cashflows set Category = 'Food' where Libelle like '%KATSURA%';
update cashflows set Category = 'Food' where Libelle like '%BOEUFSURQUAI%';
update cashflows set Category = 'Food' where Libelle like '%FRANPRIX%';
update cashflows set Category = 'Food' where Libelle like '%FENDER%';
update cashflows set Category = 'Food' where Libelle like '%CDTAGRINDOS%';
update cashflows set Category = 'Food' where Libelle like '%OSAKA%';
update cashflows set Category = 'Food' where Libelle like '%AUCOQEN%';
update cashflows set Category = 'Food' where Libelle like '%AUMIMIMARIE%';
update cashflows set Category = 'Food' where Libelle like '%TERRESNEUVAS%';
update cashflows set Category = 'Food' where Libelle like '%SUBWAY%';
update cashflows set Category = 'Food' where Libelle like '%GOURMETWOKTADEN%';
update cashflows set Category = 'Food' where Libelle like '%KFCLANGUEUX%';
update cashflows set Category = 'Food' where Libelle like '%INTERMARCHE%';
update cashflows set Category = 'Food' where Libelle like '%RESTPOINTEPLOUGONVELIN%';
update cashflows set Category = 'Food' where Libelle like '%ASTORIA%';
update cashflows set Category = 'Food' where Libelle like '%MCDO%';
...
update cashflows set Category = 'Energy' where GroupLib like '%EDF%';
update cashflows set Category = 'Energy' where Libelle like '%SHELL%';
update cashflows set Category = 'Energy' where Libelle like '%SUPERUESSENCE%';
update cashflows set Category = 'Energy' where Libelle like '%GASOL%';
update cashflows set Category = 'Energy' where Libelle like '%REL.TOTAL%';
update cashflows set Category = 'Energy' where Libelle like '%STATION%';
...
update cashflows set Category = 'Telephone' where Libelle like '%PRLVSFRFIXEADSL%';

update cashflows set Category = 'Home' where Libelle like '%IKEA%';
update cashflows set Category = 'Home' where Libelle like '%BRICODEPOT%';
update cashflows set Category = 'Home' where Libelle like '%MAGVERT%';
update cashflows set Category = 'Home' where Libelle like '%BRICO%';
update cashflows set Category = 'Home' where Libelle like '%CASTO%';
...
update cashflows set Category = 'Clothing' where Libelle like '%CHAUSSURE%';
update cashflows set Category = 'Clothing' where Libelle like '%ENFANTS%';
update cashflows set Category = 'Clothing' where Libelle like '%SEPHORA%';

update cashflows set Category = 'Boat' where Libelle like '%MARINA%';
...
update cashflows set Category = 'Health' where Libelle like '%HAIR COIF%';
update cashflows set Category = 'Health' where Libelle like '%5216259%';
...
update cashflows set Category = 'Cash' where GroupLib like '%RETRAIT%';

update cashflows set Category = 'Refund' where GroupLib like '%AVOIR%';

update cashflows set Category = 'Cmb' where GroupLib like '%CMB%';
