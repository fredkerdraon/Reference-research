...
set label 1 "mu" at 12.5000, 0.00847735, 0.00000 left norotate back nopoint
set label 2 "sigma" at 17.9772, 0.0441776, 0.00000 left norotate back nopoint
set arrow 1 from 12.0000, 0.00000, 0.00000 to 12.0000, 0.0728366, 0.00000 nohead back nofilled lt black linewidth 1.000 dashtype solid
set arrow 2 from 12.0000, 0.0441776, 0.00000 to 17.4772, 0.0441776, 0.00000 nohead back nofilled lt black linewidth 1.000 dashtype solid
set samples 200, 200
set style data lines
set ytics 0.00000,0.00847735,0.0847735 norangelimit
set title "negative binomial PDF using normal approximation" 
set xlabel "k, x ->" 
set xrange [ -2.00000 : 35.0000 ] noreverse nowriteback
set ylabel "probability density ->" 
set yrange [ 0.00000 : 0.0847735 ] noreverse nowriteback
isint(x)=(int(x)==x)
...
GPFUN_rnd = "rnd(x) = floor(x+0.5)"
r_xmin = -1
r_sigma = 4.0
n = 10
p = 0.4
mu = 12.0
sigma = 5.47722557505166
xmin = -1
xmax = 34
ymax = 0.084773490519756
lambda = 0.6
rho = 3.2
nn = 75
mm = 25
