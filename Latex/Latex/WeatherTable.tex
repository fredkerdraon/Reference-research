...
\begin{tabular}{lc...c..}
    ...
    LÃRDAL - MOLDO & \tempplot{coordinates {\lrdalmoldoTEMPDATA}}
    ...
    VÃRNES & \tempplot{coordinates {\vrnesTEMPDATA}}
    ...
    BODÃ VI & \tempplot{coordinates {\bodviTEMPDATA}}
        {60,185}{5.7} & -8.2 & 5.7 & 22.1 &
    \rainplot{coordinates {\bodviRAINDATA}}{4.0} & 4.0 & 39.5 \\
    TROMSÃ & \tempplot{coordinates {\tromsTEMPDATA}}
    ...
    NY-ÃLESUND & \tempplot{coordinates {\nylesundTEMPDATA}}
